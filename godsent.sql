...
-- Started on 2019-09-25 20:46:49
...
-- Name: hr_system; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE hr_system WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_Philippines.1252' LC_CTYPE = 'English_Philippines.1252';


ALTER DATABASE hr_system OWNER TO postgres;
...
INSERT INTO public.departments (department_id, department_name) VALUES (1, 'Sales');
INSERT INTO public.departments (department_id, department_name) VALUES (2, 'Programmers');
...
-- Completed on 2019-09-25 20:46:51
